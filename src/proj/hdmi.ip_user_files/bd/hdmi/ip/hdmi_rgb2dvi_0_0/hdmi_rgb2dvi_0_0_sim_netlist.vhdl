...
-- Date        : Tue Mar 28 23:26:59 2017
-- Host        : DESKTOP-IKIAB7U running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               F:/G9_AES/G9_InteractiveStudio-master/src/proj/hdmi.srcs/sources_1/bd/hdmi/ip/hdmi_rgb2dvi_0_0/hdmi_rgb2dvi_0_0_sim_netlist.vhdl
...
entity hdmi_rgb2dvi_0_0_OutputSERDES is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hdmi_rgb2dvi_0_0_OutputSERDES_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of hdmi_rgb2dvi_0_0_OutputSERDES_0 : entity is "OutputSERDES";
end hdmi_rgb2dvi_0_0_OutputSERDES_0;

architecture STRUCTURE of hdmi_rgb2dvi_0_0_OutputSERDES_0 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hdmi_rgb2dvi_0_0_OutputSERDES_2 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of hdmi_rgb2dvi_0_0_OutputSERDES_2 : entity is "OutputSERDES";
end hdmi_rgb2dvi_0_0_OutputSERDES_2;

architecture STRUCTURE of hdmi_rgb2dvi_0_0_OutputSERDES_2 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hdmi_rgb2dvi_0_0_OutputSERDES_4 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of hdmi_rgb2dvi_0_0_OutputSERDES_4 : entity is "OutputSERDES";
end hdmi_rgb2dvi_0_0_OutputSERDES_4;

architecture STRUCTURE of hdmi_rgb2dvi_0_0_OutputSERDES_4 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hdmi_rgb2dvi_0_0_SyncAsync is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hdmi_rgb2dvi_0_0_TMDS_Encoder is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hdmi_rgb2dvi_0_0_TMDS_Encoder_1 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of hdmi_rgb2dvi_0_0_TMDS_Encoder_1 : entity is "TMDS_Encoder";
end hdmi_rgb2dvi_0_0_TMDS_Encoder_1;

architecture STRUCTURE of hdmi_rgb2dvi_0_0_TMDS_Encoder_1 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hdmi_rgb2dvi_0_0_TMDS_Encoder_3 is
  port (
    \pDataOutRaw_reg[0]_0\ : out STD_LOGIC;
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    PixelClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of hdmi_rgb2dvi_0_0_TMDS_Encoder_3 : entity is "TMDS_Encoder";
end hdmi_rgb2dvi_0_0_TMDS_Encoder_3;

architecture STRUCTURE of hdmi_rgb2dvi_0_0_TMDS_Encoder_3 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hdmi_rgb2dvi_0_0_ResetBridge is
  port (
    \out\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    aRst_n : in STD_LOGIC;
    PixelClk : in STD_LOGIC
...
begin
SyncAsyncx: entity work.hdmi_rgb2dvi_0_0_SyncAsync
     port map (
      AS(0) => aRst_int,
      PixelClk => PixelClk,
      \out\(0) => \out\(0)
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hdmi_rgb2dvi_0_0_rgb2dvi is
  port (
    TMDS_Clk_p : out STD_LOGIC;
    TMDS_Clk_n : out STD_LOGIC;
  ...
  attribute kClkPrimitive of hdmi_rgb2dvi_0_0_rgb2dvi : entity is "MMCM";
  attribute kClkRange : integer;
  attribute kClkRange of hdmi_rgb2dvi_0_0_rgb2dvi : entity is 2;
  attribute kGenerateSerialClk : string;
  attribute kGenerateSerialClk of hdmi_rgb2dvi_0_0_rgb2dvi : entity is "FALSE";
  attribute kRstActiveHigh : string;
  attribute kRstActiveHigh of hdmi_rgb2dvi_0_0_rgb2dvi : entity is "FALSE";
end hdmi_rgb2dvi_0_0_rgb2dvi;

architecture STRUCTURE of hdmi_rgb2dvi_0_0_rgb2dvi is
...
begin
ClockSerializer: entity work.hdmi_rgb2dvi_0_0_OutputSERDES
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
...
\DataEncoders[0].DataEncoder\: entity work.hdmi_rgb2dvi_0_0_TMDS_Encoder
     port map (
...
\DataEncoders[0].DataSerializer\: entity work.hdmi_rgb2dvi_0_0_OutputSERDES_0
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
...
\DataEncoders[1].DataEncoder\: entity work.hdmi_rgb2dvi_0_0_TMDS_Encoder_1
     port map (
      D(0) => \DataEncoders[0].DataEncoder_n_2\,
      PixelClk => PixelClk,
...
\DataEncoders[1].DataSerializer\: entity work.hdmi_rgb2dvi_0_0_OutputSERDES_2
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
...
\DataEncoders[2].DataEncoder\: entity work.hdmi_rgb2dvi_0_0_TMDS_Encoder_3
     port map (
...
\DataEncoders[2].DataSerializer\: entity work.hdmi_rgb2dvi_0_0_OutputSERDES_4
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
...
LockLostReset: entity work.hdmi_rgb2dvi_0_0_ResetBridge
     port map (
      PixelClk => PixelClk,
      aRst_n => aRst_n,
      \out\(0) => pRstLck
...
entity hdmi_rgb2dvi_0_0 is
  ...
  attribute NotValidForBitStream of hdmi_rgb2dvi_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of hdmi_rgb2dvi_0_0 : entity is "hdmi_rgb2dvi_0_0,rgb2dvi,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of hdmi_rgb2dvi_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of hdmi_rgb2dvi_0_0 : entity is "rgb2dvi,Vivado 2016.2";
end hdmi_rgb2dvi_0_0;

architecture STRUCTURE of hdmi_rgb2dvi_0_0 is
  attribute kClkPrimitive : string;
...
begin
U0: entity work.hdmi_rgb2dvi_0_0_rgb2dvi
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
      TMDS_Clk_n => TMDS_Clk_n,
